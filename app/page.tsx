...
export default function Home() {
    ...
    return (
        <div className="min-h-screen bg-zinc-950 text-zinc-100 font-sans antialiased selection:bg-rose-500 selection:text-white">
            ...
            >
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
                    ...
                    <nav className="hidden md:flex items-center gap-8 text-sm font-medium text-zinc-400">
                        ...
                        <a href="#tshirt" className="hover:text-white transition-colors">
                            티셔츠
                        </a>
                        <a href="#keyring" className="hover:text-white transition-colors">
                            키링
                        </a>
                        <a href="#badge" className="hover:text-white transition-colors">
                            뱃지
                        </a>
                        <a href="#sticker" className="hover:text-white transition-colors">
                            스티커
                        </a>
            ...
            {/* Footer / Sponsorship Section (Bottom) */}
            <footer id="support" className="bg-zinc-950 pt-20 pb-12 relative overflow-hidden">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="grid lg:grid-cols-12 gap-12 pb-16 border-b border-zinc-900">
                        {/* Left content: campaign info */}
                        <div className="lg:col-span-7 space-y-6">
                            <h3 className="text-xl font-bold text-white">잠실민주화 정신 확산 캠페인 후원</h3>
                            <p className="text-zinc-400 text-sm sm:text-base leading-relaxed max-w-2xl font-light">
                                잠실민주화 정신 확산을 위해 <strong className="text-zinc-200">올공키링</strong>과{' '}
                                <strong className="text-zinc-200">신전대협</strong>이 뜻을 함께 합니다.
                                <br />
                                <br />
                                잠실민주화운동 심볼 확산에 후원하시고 싶으신 분은 아래의 후원 계좌로 동참 부탁드립니다.
                                후원해주신 소중한 금액은 캠페인 심볼의 지속적인 오프라인 배포 및 추가 무료 배포 물량
                                제작을 위해서 투명하고 소중하게 전액 사용될 예정입니다.
                            </p>
                        </div>
